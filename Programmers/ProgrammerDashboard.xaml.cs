...
using DetailTrack.Programmers.Windows;
using Microsoft.EntityFrameworkCore;
using System.Windows;
using System.Windows.Controls;
using System.Windows.Input;

namespace DetailTrack.Programmers
{
    public partial class ProgrammerDashboard : Window
    {
        private ApplicationDbContext _context;

        public ProgrammerDashboard()
        {
        ...
        private void LoadRequestsList(string statusFilter = null, string searchQuery = null)
        {
            ...
            var query = _context.Requests
                ...
                .Where(r => r.ProgrammerId == Session.CurrentUser.Id)
        ...
        private void DgRequests_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            ...
            var details = new ProgrammerRequestDetailsWindow(selected, selected.IsRemoved);
            details.Owner = this;
